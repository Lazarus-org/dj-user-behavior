## Code of Conduct for Contributing to Django User Behavior

we’re thrilled that you want to contribute to `dj-user-behavior`! to ensure a positive and protective environment for everyone involved, please adhere to the following guidelines.

## Contribution Workflow

1. **Fork and Clone**: Start by forking the `dj-user-behavior` repository on Github and cloning it to your local machine:
    ```bash
    git clone https://github.com/lazarus-org/dj-user-behavior.git
    cd dj-user-behavior
    ```
...
Thank you for contributing to `dj-user-behavior`! We look forward to your contributions.
