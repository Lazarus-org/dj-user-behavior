# Contributing to Django User Behavior


We’re excited that you’re interested in contributing to `dj-user-behavior`! Whether you’re fixing a bug, adding a feature, or improving the project, your help is appreciated.
...
1. **Fork the Repository:**
   ...
   Begin by forking the `dj-user-behavior` repository on GitHub. This creates your own copy where you can make changes.
...
2. **Clone Your Fork:**
   ...
   ```bash
   git clone https://github.com/your-username/dj-user-behavior.git
   cd dj-user-behavior
   ```
...
For linting, `pylint` is used to enforce style and catch potential errors:
   ...
   ```bash
   poetry run pylint user_behavior
   ```
...
3. **Open a Pull Request:**
   ...
   Go to the original `dj-user-behavior` repository and open a pull request. Include a detailed description of your changes and link any related issues.
...
1. **Open an Issue:**
   ...
   Head over to the `Issues` section of the `dj-user-behavior` repository and click "New Issue".
...
Thank you for your interest in contributing to `dj-user-behavior`! We look forward to your contributions.
