...
def page_view_serializer_class() -> Type[BaseSerializer]:
    """Get the serializer class for the PageView model, either from config or the default.
...
def user_session_serializer_class() -> Type[BaseSerializer]:
    """Get the serializer class for the UserSession model, either from config or the default.
...
def user_interaction_serializer_class() -> Type[BaseSerializer]:
    """Get the serializer class for the UserInteraction model, either from config or the default.
